...
const FEEDS = {
  ...
  ev: [
    { source: "Automarket", url: "https://news.google.com/rss/search?q=masina+electrica+when:14d+site:automarket.ro&hl=ro&gl=RO&ceid=RO:ro" },
    { source: "EVmarket",   url: "https://news.google.com/rss/search?q=masini+electrice+site:evmarket.ro&hl=ro&gl=RO&ceid=RO:ro" },
    { source: "Green Report", url: "https://news.google.com/rss/search?q=masini+electrice+site:green-report.ro&hl=ro&gl=RO&ceid=RO:ro" },
    { source: "EV România",  url: "https://news.google.com/rss/search?q=%22masini+electrice%22+Rom%C3%A2nia+when:14d&hl=ro&gl=RO&ceid=RO:ro" },
  ],
  explorer: [
    { source: "Ford Explorer", url: "https://news.google.com/rss/search?q=Ford+Explorer+electric&hl=ro&gl=RO&ceid=RO:ro" },
  ],
};
...
const SEARCH_LOCALE = {
  ...
  ev:       { hl: "ro", gl: "RO", ceid: "RO:ro", suffix: " masina electrica" },
  explorer: { hl: "ro", gl: "RO", ceid: "RO:ro", suffix: " Ford Explorer" },
};
